...
use Biz\ErrorCode as BizErrorCode;

class ErrorCode extends BizErrorCode
{
    /**
     * API不存在 (http code: 404).
     */
    ...
    /**
     * 2. 认证信息已过期 (http code: 401).
     */
    const EXPIRED_CREDENTIAL = 5;

    /**
     * 5. Credential对应的用户被禁止 (http code: 401).
     */
